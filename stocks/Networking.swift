...
enum Endpoints {
    ...
    var url: URL {
        ...
        case .balanceSheetAnnual(ticker: let ticker): return URL(string: "https://financialmodelingprep.com/api/v3/financials/balance-sheet-statement/\(ticker)") ?? URL(fileURLWithPath: "")
